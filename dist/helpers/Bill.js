...
const Bills = "bills";
const billCollectionRef = (0, firestore_1.collection)(firebase_1.db, Bills);
class BillController {
    constructor() {
        ...
        this.add = (bill) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, firestore_1.addDoc)(billCollectionRef, bill);
        });
        this.update = (id, bill) => __awaiter(this, void 0, void 0, function* () {
            const tutorialDoc = (0, firestore_1.doc)(firebase_1.db, Bills, id);
            return yield (0, firestore_1.updateDoc)(tutorialDoc, Bills, bill);
        });
    }
}
