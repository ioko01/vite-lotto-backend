...
const bill_1 = require("./api/bill");
const user_1 = require("./api/user");
const store_1 = require("./api/store");
const default_1 = require("./config/default");
const cookie_parser_1 = __importDefault(require("cookie-parser"));
const authenticate_1 = require("./middleware/authenticate");
const lotto_1 = require("./api/lotto");
const rate_1 = require("./api/rate");
const digitSemi_1 = require("./api/digitSemi");
const digitClose_1 = require("./api/digitClose");
const checkReward_1 = require("./api/checkReward");
(0, dotenv_1.config)();
